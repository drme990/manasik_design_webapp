...
export const ASPECT_RATIOS = [
    { label: '1:1 مربع', ratio: 1, width: 1080, height: 1080 },
    { label: '4:5 بوست', ratio: 0.8, width: 1080, height: 1350 },
    { label: '9:16 ستوري', ratio: 0.5625, width: 1080, height: 1920 },
    { label: '16:9 عرضي', ratio: 1.7778, width: 1920, height: 1080 },
    { label: '3:4', ratio: 0.75, width: 1080, height: 1440 },
    { label: '2:3', ratio: 0.6667, width: 1080, height: 1620 },
];
